...
def logins(request):
    ...
    if request.method=="POST":
        ...
        if username == 'yashwanth' and password == 'yashwanth':
            return redirect('admins:home')
        elif username == 'raghu' and password == 'raghu':
            return redirect('admins:home')
        elif username == 'rohit' and password == 'rohit':
            return redirect('admins:home')
        elif username == 'satvika' and password == 'satvika':
            return redirect('admins:home')
        elif username == 'gayatri' and password == 'gayatri':
            return redirect('admins:home')    
        else:
